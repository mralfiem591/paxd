...
Environment Variables:
  PAXD_GH_TOKEN: GitHub personal access token (required)
    ...
    if args.print_warning_paths:
        ...
        print(f"If you attempt to publish from any of these paths, for example, {os.path.expanduser('~')}, you will receive a warning prompt asking if you want to continue.")
        sys.exit(0)
