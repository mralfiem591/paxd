...
if paxd_ready.status_code != 200:
    print(Fore.RED + f"ERROR: The provided repository does not appear to be PaxD-ready (missing com.mralfiem591.paxd package) (checked: {repo}/packages/com.mralfiem591.paxd/src/main.py). Installation aborted.")
